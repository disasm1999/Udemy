...
def get_content(html):
    items = html.split('nn<div "="" class="stm_lms_courses__single no-sale="" stm_lms_courses__single_animation=""')
    udemy = []
    for item in items:
...
data = data.replace('n this="">n        <div>n            <div class="stm_lms_lazy_image"><img ="" "="" alt="98dab8124423244675bd47e810e90182" class="lazyload', '').replace("'", "")
